 ...
 * taking values from the IAgent
 */
export async function validateInstagramConfig(
): Promise<InstagramConfig> {
    try {
        const instagramConfig = {
            INSTAGRAM_DRY_RUN: process.env.INSTAGRAM_DRY_RUN === "true",
            ...
            INSTAGRAM_BUSINESS_ACCOUNT_ID:
                process.env.INSTAGRAM_BUSINESS_ACCOUNT_ID || undefined,
            ...
            INSTAGRAM_ENABLE_ACTION_PROCESSING:
                process.env.INSTAGRAM_ENABLE_ACTION_PROCESSING === "true",
