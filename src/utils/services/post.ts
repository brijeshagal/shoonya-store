...
export class InstagramPostService {
    ...
    private async generateNewPost() {
        try {
            console.log("Generating new Instagram post");

            // const roomId = stringToUuid(
            //     "instagram_generate_room-" + this.state.profile?.username
            // );

            // console.debug("generate post prompt:\n" + context);
            ...
            console.error("Error generating Instagram post:", {
    ...
    private async getOrGenerateImage(content: string) {
        try {
            console.log("Generating image for Instagram post");
        ...
        // if (!cleanedContent) {
        //     console.error("Failed to extract valid content from response:", {
        //         rawResponse: content,
        //         attempted: "JSON parsing",
        //     });
        //     return;
